    ...
    <div className="review-section" id="reviews">
      <div className="rw-text-content">
        ...
        <div className="reviews-header-container">
          <h2 className="reviews-main-title">Clients experiences that speak for themselves</h2>
          ...
          <div className="reviews-google-summary">
            ...
            <div className="reviews-stars-text">
              ...
              <p className="reviews-count-text">4.7 Customer Reviews</p>
            </div>
          </div>
        </div>

        <div className='sk-ww-google-reviews' data-embed-id='25654584'></div>
      </div>
    </div>
  );
}
